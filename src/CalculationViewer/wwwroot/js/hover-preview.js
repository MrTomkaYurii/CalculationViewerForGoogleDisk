// Предпросмотр по наведению: мышь неподвижно на картинке дольше DWELL мс (1 с), и она раскрывается на весь экран.
...
(() => {
    const DWELL = 1000;     // сколько держать мышь, мс: меньше — предпросмотр выскакивает при обычной прокрутке и просмотре списка
    const PREFETCH = 500;   // когда начинать подгружать оригинал: половина DWELL, чтобы проходящий мимо курсор не гонял трафик
